...
if st.button(f'Show correlation'):
    if gene1 != '' and gene2 != '':
        ...
        st.error('Introduce desired genes to see correlation')
    elif gene1 == '':
        st.error('You need to indicate the first gene to see correlation')
    elif gene2 == '':
        st.error('You need to indicate the second gene to see correlation')